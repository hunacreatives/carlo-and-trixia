export default function Welcome() {
  return (
    <section className="absolute left-0 top-0 w-[1512px] text-center text-white">
      {/* Heading */}
      <h2 className="absolute left-[763px] top-[1274px] w-[904px] -translate-x-1/2 -translate-y-1/2 font-heading text-[104px] leading-none text-white">
        Welcome
      </h2>

      {/* Body */}
      <div className="absolute left-[755px] top-[1369px] w-[1100px] -translate-x-1/2 space-y-5 font-serif text-[22px] leading-relaxed text-white">
        <p>
        ...
        <p className="pt-6">
          With all our love,
          <br />
          <span className="font-script text-[46px] leading-[1.1]">
            Trixia &amp; Don Carlo
          </span>
        </p>
      </div>
